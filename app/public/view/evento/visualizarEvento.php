        ...
        <div class="col s12">
            <div class="card deep-purple lighten-4">
                ...
                <div class="card-action">
                    <a class="deep-purple-text accent-3" href="http://127.0.0.1/application/evento/removerEvento.php?cod_evento=<?= $evento["cod_evento"]; ?>"> Remover </a>
                    <a class="deep-purple-text accent-3" href="http://127.0.0.1/view/evento/atualizarEvento.php?cod_evento=<?= $evento["cod_evento"]; ?>"> Atualizar </a>
                </div>
            </div>
        </div>
    </div>
